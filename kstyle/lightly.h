...
enum AnimationParameter { AnimationDefaut = 0, AnimationForwardOnly = 0x1, AnimationOutBack = 0x2, AnimationLongDuration = 0x4 };
...
//* sides
enum Side { SideLeft = 0x1, SideTop = 0x2, SideRight = 0x4, SideBottom = 0x8, AllSides = SideLeft | SideTop | SideRight | SideBottom };
