...
//______________________________________________________________________________
void Helper::renderProgressBarGroove(QPainter *painter, const QRect &rect, const QColor &color, const bool isContent) const
{
    // setup painter
    painter->setRenderHint(QPainter::Antialiasing, true);
    ...
    if (!isContent)
        thickness = qMax(Metrics::ProgressBar_Thickness - 2, 0);
